...
const Faq = () => {
  return (
    <section id="FAQs" className='lg:px-32 px-[1rem] my-4 lg:my-8 py-10'>
        ...
        <p className='text-[#F27405] text-start font-light pt-10 pb-2'>FAQs</p>
      </div>
         <h1 className='text-3xl text-left lg:text-6xl font-bold'>Frequently Asked <br />Questions.</h1>
         <br />
      
        </div>
        <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
            <AccordionTrigger>What types of services does Radii offer?</AccordionTrigger>
            <AccordionContent>
        ...
        <AccordionItem value="item-2">
            <AccordionTrigger>Is my data secure with Radii?</AccordionTrigger>
            <AccordionContent>
        ...
        <AccordionItem value="item-3">
            <AccordionTrigger className='text-start'>Can I get a customized report for my specific needs?</AccordionTrigger>
            <AccordionContent>
        ...
        <AccordionItem value="item-4">
            <AccordionTrigger>How long does it take to get a report?</AccordionTrigger>
            <AccordionContent>
        ...
        <AccordionItem value="item-5">
            <AccordionTrigger>How can I partner with Radii?</AccordionTrigger>
            <AccordionContent>
        ...
        <AccordionItem value="item-6">
            <AccordionTrigger>How do I get started with Radii?</AccordionTrigger>
            <AccordionContent>
